...
export const metadata: Metadata = {
  ...
  description: "Accessibility Statement template for Company Name.",
  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-20">
      ...
      <p className="mt-6 text-lg leading-8 text-slate-600">
        Company Name aims to make this website accessible and usable for as many people as possible, following WCAG 2.2 AA principles where practical.
      </p>
