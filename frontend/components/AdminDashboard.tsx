  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-10">
      <div className="flex flex-col justify-between gap-4 border-b border-slate-200 pb-6 md:flex-row md:items-center">
        <div>
          <p className="text-sm font-semibold uppercase text-[#0b4fd8]">Admin</p>
        ...
        <div className="flex gap-3">
          ...
          <button className="rounded-md bg-[#07112f] px-4 py-2 font-semibold text-white" onClick={signOut} type="button">
            Sign out
          </button>
        </div>
      </div>
      ...
      <section className="mt-8">
        ...
        {submissions.length > 0 ? (
          <div className="mt-5 overflow-x-auto rounded-md border border-slate-200 bg-white/90">
            <table className="min-w-full border-collapse text-left text-sm">
              <thead className="bg-blue-50/40 text-slate-700">
                <tr>
